...
// BF16 输入、FP32 累加的 CuTe GEMM。主循环参考 CUTLASS
...
void cute_gemm_bf16_fp32_kernel(
    ...
    BlockRasterMode block_raster_mode)
{
    ...
    const auto kernel = cute_gemm_bf16_fp32_kernel<
...
int main(int argc, char **argv)
{
    try
    {
        ...
        {
            throw std::runtime_error(
                "BF16 Tensor Core GEMM requires compute capability 8.0+");
        }
