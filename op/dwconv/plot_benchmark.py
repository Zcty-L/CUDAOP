...
fig.suptitle("Depthwise Conv Performance: custom vs cuDNN (NCHW/NHWC)", fontsize=14, y=1.02)
fig.tight_layout()
fig.savefig("benchmark_all.png", dpi=150, bbox_inches="tight")
print("Saved benchmark_all.png")
